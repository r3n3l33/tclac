...
class tclacClimate : public climate::Climate, public esphome::uart::UARTDevice, public PollingComponent {
	...
	private:
		...
		byte setup1[8] = {0xBB,0x00,0x01,0x09,0x02,0x04,0x00,0xB5};
		byte setup2[9] = {0xBB,0x00,0x01,0x0A,0x03,0x02,0x00,0x05,0xB4};
		byte setup2[7] = {0xBB,0x00,0x01,0x02,0x04,0x00,0xB5};
