...
class tclacClimate : public climate::Climate, public esphome::uart::UARTDevice, public PollingComponent {
	...
	//dataTX[7] = 0x05;
	//dataTX[8] = 0xB4;
	//BB 00 01 09 02 04 00 B5
		//byte poll[9] = {0xBB,0x00,0x01,0x0A,0x03,0x02,0x00,0x05,0xB4};
		//byte polli[8] = {0xBB,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
		//byte poll2[5] = {0x03,0x02,0x00,0x05, 0xB4};
		byte poll[8] = {0xBB,0x00,0x01,0x04,0x02,0x01,0x05,0xBD};
		//byte poll[8] = {0xBB,0x00,0x01,0x04,0x02,0x04,0x00,0xB5};

		//byte poll[25] = {0x6F,0x4F,0xEB,0x6F,0x7E,0xBC,0xC0,0x1B,0xC0,0x26,0x48,0x67,0x67,0xD9,0xCD,0x4F,0x92,0xF2,0x5A,0x55,0xFF,0xBB,0x5E,0xBB,0x29};
